            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12 col-xl-4">
                    ...
                    <div class="list-menu toggle-mn list-info">
                        ...
                        <div class="content-contact clearfix">
                            <span class="list_footer">
                                <b>Điện thoại: </b><a title="{{$config->hotline}}" href="tel:{{ str_replace(' ', '', $config->hotline) }}">
                                    {{$config->hotline}}
                                </a>
                            </span>
                        </div>
                            ...
                            <span class="list_hotline">
                                <a title="{{$config->hotline}}" href="tel:{{ str_replace(' ', '', $config->hotline) }}">
                                    <img width="24" height="24"
                                        src="/site/images/phone_foo.png?1740037266911"
                                        alt="Hotline" /> {{$config->hotline}}
                                </a>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="social-footer">
                        <div class="social toggle-mn">
                            ...
                            <a class="tt" href="{{$config->twitter}}" target="_blank" aria-label="Twitter"
                                title="Theo dõi {{$config->web_title}} trên Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a class="ins" href="{{$config->instagram}}" target="_blank" aria-label="Instagram"
                                title="Theo dõi {{$config->web_title}} trên Instagram">
                    ...
                    <div class="footer-column-1">
                        <div class="payment-accept">
                            <img width="70" height="40"
                                ...
                                data-src="/site/images/payment-1.png?1740037266911"
                                alt="Payment 1" class="lazyload">
                            <img width="70" height="40"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC"
                                data-src="/site/images/payment-2.png?1740037266911"
                                alt="Payment 2" class="lazyload">
                            <img width="70" height="40"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC"
                                data-src="/site/images/payment-3.png?1740037266911"
                                alt="Payment 3" class="lazyload">
                            <img width="70" height="40"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC"
                                data-src="/site/images/payment-4.png?1740037266911"
