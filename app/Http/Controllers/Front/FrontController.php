...
class FrontController extends Controller
{
    ...
    public function showProductDetail($slug) {
        try {
            ...
            return view('site.products.product_detail', compact('categories', 'product', 'productsRelated', 'category', 'arr_product_rate_images', 'bestSellerProducts', 'canReview', 'vouchers', 'isProductFlashsale', 'dateFlashsale'));
